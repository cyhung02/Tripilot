    ...
    return (
        <div className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-500">
            ...
            <div className="flex border-b">
                <button
                    className={`flex-1 py-3 font-medium text-center transition-colors ${activeTab === 'schedule'
                ...
                <button
                    className={`flex-1 py-3 font-medium text-center transition-colors ${activeTab === 'food'
                            ? `${themeColors.accent} text-white`
                            : 'text-gray-600 hover:bg-gray-100'
                        }`}
                ...
                {day.mustBuyItems && day.mustBuyItems.length > 0 && (
                    <button
                        className={`flex-1 py-3 font-medium text-center transition-colors ${activeTab === 'shopping'
                                ? `${themeColors.accent} text-white`
                                : 'text-gray-600 hover:bg-gray-100'
                            }`}
